...
//            }
   ...
   func setProgressInfo(progressRate: String, currentClass: String, totalClass:String){
    ...
    func setNotesInfos(){
        //dummy data
        let data1 = NotesInfo(classLog: .yellow, currentClass: "1회차 2시간/8시간", lesson: "수학의정석 1장", homework: "수학의정석 1장 연습문제")
        let data2 = NotesInfo(classLog: .yellow, currentClass: "2회차 4시간/8시간", lesson: "수학의정석 2장", homework: "수학의정석 2장 연습문제")
        let data3 = NotesInfo(classLog: .yellow, currentClass: "3회차 6시간/8시간", lesson: "수학의정석 3장", homework: "수학의정석 3장 연습문제")
        let data4 = NotesInfo(classLog: .yellow, currentClass: "4회차 8시간/8시간", lesson: "수학의정석 4장", homework: "수학의정석 4장 연습문제")
        let data5 = NotesInfo(classLog: .red, currentClass: "1회차 1시간/6시간", lesson: "통기타 너도 할수 있어! 1장", homework: "수학의정석 4장 연습문제")
        let data6 = NotesInfo(classLog: .red, currentClass: "2회차 10시간/16시간", lesson: "통기타 너도 할수 있어! 2장", homework: "너에게 난 나에게 넌")
        let data7 = NotesInfo(classLog: .red, currentClass: "3회차 10시간/16시간", lesson: "통기타 너도 할수 있어! 3장", homework: "제주도의 푸른 밤")
        let data8 = NotesInfo(classLog: .red, currentClass: "4회차 10시간/16시간", lesson: "통기타 너도 할수 있어! 4장", homework: "징가징가~")
        let data9 = NotesInfo(classLog: .red, currentClass: "5회차 10시간/16시간", lesson: "통기타 너도 할수 있어! 5장", homework: "붉은 노을")
        let data10 = NotesInfo(classLog: .red, currentClass: "6회차 10시간/16시간", lesson: "통기타 너도 할수 있어! 6장", homework: "겨울을 걷는다")
